...
@IBDesignable class RatingControl: UIStackView {
    ...
    private func setupButtons(){
        ...
        for index in 0..<starCount{
            ...
            //The #selector expression returns the Selector value for the provided method. A selector is an opaque value that identifies the method.
